...
- **プロセス報酬 vs 結果報酬**: 途中のステップに報酬を与える PRM は理屈上は魅力的だが、R1 チームはステップ定義・中間正誤判定・reward hacking の三重苦で断念し、**結果報酬だけで創発に賭けて勝った**。MCTS による探索の組み込みも、トークン生成の指数的探索空間で頓挫している。
...
- [[test-time-compute]] — 思考長の自己獲得（未作成）
