...
- [[summaries/2022-gptq]] — 本論文を「結局は最近接へ丸めているだけ」と括った同時期の研究。メモリは減らすがレイテンシは FP16 と同じ、という対比も明示している
- [[summaries/2023-awq]] — 本論文の「1% を高精度で残す」を出発点にしつつ、混合精度を使わずに同じ効果を出す道を取った後続研究
